...
class DiscountOptimizationTest {
	...
	static final double[] DISCOUNTS = new double[] {0, 0.05, 0.15, 0.2, 0.25};
	...
	static final String VALUE_TEST_FAILS = """
			The expected output was %.2f, but the actual is %.2f %n""";
	...
	private static void test10000() {
		...
		printValueResult("Test10000", new BigDecimal("8.0"), 
	...
	private static void test11100() {
		...
		printValueResult("Test33300", new BigDecimal("21.6"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test33332() {
		...
		printValueResult("Test33332", new BigDecimal("85.6"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test33321() {
		...
		printValueResult("Test33321", new BigDecimal("76.8"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test30000() {
		...
		printValueResult("Test30000", new BigDecimal("24.0"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test22211() {
		...
		printValueResult("Test22211", new BigDecimal("51.2"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test11222() {
		...
		printValueResult("Test11222", new BigDecimal("51.2"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test11111() {
		...
		printValueResult("Test30000", new BigDecimal("30.0"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test33333() {
		...
		printValueResult("Test30000", new BigDecimal("90.0"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test54321() {
		...
		printValueResult("Test54321", new BigDecimal("100.0"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void test12345() {
		...
		printValueResult("Test12345", new BigDecimal("100.0"), 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void testNull() {
		...
		printValueResult("TestNull", BigDecimal.ZERO, 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
	...
	private static void testEmpty() {
		...
		printValueResult("TestEmpty", BigDecimal.ZERO, 
				DiscountOptimizer.calculateTotalSum(resultList));
	}
