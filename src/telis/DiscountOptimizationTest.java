...
class DiscountOptimizationTest {
	...
	static final Set<String> RESULT_SET_1 = new HashSet<>(Arrays.asList("1"));
	
	static final Set<String> RESULT_SET_123 
		= new HashSet<>(Arrays.asList("1","2","3"));
	
	static final Set<String> RESULT_SET_12 = new HashSet<>(Arrays.asList("1","2"));
	
	static final Set<String> RESULT_SET_12345 
		= new HashSet<>(Arrays.asList("1","2","3","4","5"));
	
	static final Set<String> RESULT_SET_1234 
		= new HashSet<>(Arrays.asList("1","2","3","4"));
	
	static final Set<String> RESULT_SET_1235 
		= new HashSet<>(Arrays.asList("1","2","3","5"));

	static final Set<String> RESULT_SET_1345 
		= new HashSet<>(Arrays.asList("1","3","4","5"));
	
	static final Set<String> RESULT_SET_2345 
		= new HashSet<>(Arrays.asList("2","3","4","5"));
	
	static final Set<String> RESULT_SET_5 = new HashSet<>(Arrays.asList("5"));
	
	static final Set<String> RESULT_SET_45 = new HashSet<>(Arrays.asList("4","5"));
	...
	private static void testNull() {
		...
		List<Set<String>> resultList = DiscountOptimizer.purchaseAllUnits(null);
